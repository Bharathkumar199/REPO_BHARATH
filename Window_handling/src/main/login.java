...
public class login extends base_page
{
	...
	static By by_UN=By.xpath("//input[@type='email']");
	...
	{
		return driver.findElement(by_sign);
	}

	
	static WebElement ele_UN()
	{
		return driver.findElement(by_UN);
	}
	static WebElement ele_count()
	{
		return driver.findElement(by_count);
	}
	static WebElement ele_PW()
	{
		return driver.findElement(by_PW);
	}
	static WebElement ele_submit()
	{
		return driver.findElement(by_submit);
	}
